...
#Offshore wind
xls_off = pd.ExcelFile("../Input Data/Pan-European Climate Database (1)/Pan-European Climate Database/Solar and Wind Data/PECD_2030_Offshore.xlsx",engine = 'openpyxl')
...
xls_on = pd.ExcelFile("../Input Data/Pan-European Climate Database (1)/Pan-European Climate Database/Solar and Wind Data/PECD_2030_Onshore.xlsx",engine = 'openpyxl')
...
xls_pv = pd.ExcelFile("../Input Data/Pan-European Climate Database (1)/Pan-European Climate Database/Solar and Wind Data/PECD_2030_PV.xlsx",engine = 'openpyxl')
